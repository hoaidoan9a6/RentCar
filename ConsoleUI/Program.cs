...
namespace ConsoleUI
{
    internal class Program
    {
        ...
        private static void CarTest()
        {
            ...
            //carManager.Add(new Car {  BrandId = 1, ColorId = 3, CarName = "B", ModelYear = 2021, DailyPrice = 2500, Description = "AMGv2" });
            carManager.Update(new Car { Id = 8, BrandId = 1, ColorId = 3, CarName = "BFFSFS", ModelYear = 2019, DailyPrice = 18000, Description = "TSI" });
